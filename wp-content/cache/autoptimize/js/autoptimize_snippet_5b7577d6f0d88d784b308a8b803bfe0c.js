...
if(Modernizr._config.enableClasses){className+=' '+classPrefix+classes.join(' '+classPrefix);if(isSVG){docElement.className.baseVal=className;}else{docElement.className=className;}}};testRunner();setClasses(classes);for(var i=0;i<Modernizr._q.length;i++){Modernizr._q[i]();}
