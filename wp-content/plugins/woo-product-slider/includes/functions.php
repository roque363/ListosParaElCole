			...
			<div class="feature-section three-col">
				<div class="col">
					<div class="sp-wps-feature sp-wps-text-center">
						...
						<a href="https://wordpress.org/support/plugin/woo-product-slider" target="_blank" class="button button-primary">Contact Support</a>
					</div>
				</div>
				<div class="col">
					<div class="sp-wps-feature sp-wps-text-center">
				...
				<div class="col">
					<div class="sp-wps-feature sp-wps-text-center">
						...
						<a href="https://github.com/ShapedPlugin/WooCommerce-Product-Slider" target="_blank" class="button button-primary">Report to GitHub</a>
					</div>
				</div>
			</div>
